...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    lui [[A0:a[0-9]+]], %hi(tgt_qubits)
; CHECK-NEXT:    addi [[A0]], [[A0]], %lo(tgt_qubits)
; CHECK-NEXT:    vl1r.v [[V8:v[0-9]+]], ([[A0]])
; CHECK-NEXT:    lui [[A0]], %hi(ctrl_qubits)
; CHECK-NEXT:    addi [[A0]], [[A0]], %lo(ctrl_qubits)
; CHECK-NEXT:    vl1r.v [[V9:v[0-9]+]], ([[A0]])
; CHECK-NEXT:    li [[A0]], 2
; CHECK-NEXT:    li [[A1:a[0-9]+]], 85
; CHECK-NEXT:    vsetvli zero, [[A0]], e8, m1, ta, ma
; CHECK-NEXT:    qv.h [[V8]], [[A1]], 12
; CHECK-NEXT:    li [[A0]], 4
; CHECK-NEXT:    vsetvli zero, [[A0]], e8, m1, ta, ma
; CHECK-NEXT:    qv.cx [[V8]], [[V9]], 12
; CHECK-NEXT:    qv.mz [[V8]], [[A1]], 12
; CHECK-NEXT:    ret
